...
public class Body {
    ...
    public Vector3 acceleration(Body b) {
        //TODO: implement method.
        Vector3 new_vek = b.massCenter.minus(this.massCenter);
        double abstand = new_vek.length();
        new_vek.normalize();
        double a = Simulation.G * b.mass / (abstand * abstand);
        return new_vek.times(a);
    }
    ...
    public Body merge(Body b) {
        ...
        return new Body(new_mass, new_mass_center, new_movement);
    }
    ...
    public String toString() {
        //TODO: implement method.
        return "\""+mass+" kg, position: "+massCenter.toString()+" m, movement: "+ currentMovement.toString()+" m/s.\"";
    }
}
